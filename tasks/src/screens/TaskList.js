    ...
    render () {
        ...
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity activeOpacity={0.7} onPress={() => this.setState({showAddTask: true})} style={styles.addButton} >
...
const styles = StyleSheet.create({
    ...
    titleBar: {
        flex: 1,
        justifyContent: 'flex-end' // n react-native o eixo principal é o eixo y, no react js é o eixo x
